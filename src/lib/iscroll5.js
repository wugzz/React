...
// INSERT POINT: _refresh
        ...
        /**
         * 滚动到： x ， y ，事件， easing 方式
         * @param x:int
         * @param y:int
         * @param time:int
         * @param easing - Easing: quadratic | circular | back | bounce | elastic 见 IScroll.utils.ease  对象
         ...
         * @param el 为必须的参数
         * @param time
         * @param offsetX 相对于 el 元素的位移 设为 true 即为屏幕中心
         * @param offsetY 相对于 el 元素的位移 设为 true 即为屏幕中心
         * @param easing
         */
